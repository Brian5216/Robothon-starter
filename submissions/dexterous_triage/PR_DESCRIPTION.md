...
- v12 highlights: preserves the strongest 89.3 evidence package, tightens the demo from 64s to 60s, removes duplicate caption layers, keeps only concise SRT subtitles, adds short key-moment badges for stable grasp, cap rotation, and slip recovery, and documents a real-world physical-test protocol honestly in the report.
