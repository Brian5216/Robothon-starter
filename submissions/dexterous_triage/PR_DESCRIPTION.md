...
- Technical approach: Deterministic imitation-style stage prior plus closed-loop residual policy using visual-servo/contact/slip feedback, with MJCF joints, actuators, free bodies, collision geometry, frame sensors, touch sensors, compact telemetry overlays, one-word SRT subtitles, trajectory JSON, five-finger contact timeline, policy card, fixed-seed stress evaluation, and self-audit report.
